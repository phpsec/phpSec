...
class phpsecOtp {
   ...
   *   provided by phpsecOtp::psSelect().
   *
   * @param string $otp
   ...
   */
  public static function psSelect($cardId) {
   ...
   */
  public static function psLoad($cardId) {
   ...
   */
  public static function psRemaining($cardId) {

  }

  /**
   * Save a password card. Can only be called after phpsecOtp::psHash().
   *
   * @param array $card
   ...
   *
   * @return array
   *   Arrray containing hashed card data. Ready for phpsecOtp::psSave().
   */
